...
class BuoyancyCalculator(object):
   ...
   def select_action(self, selection):
       if selection == "1":
           ...
           mass=float(input("mass(gram): "))
           volume = float(input("vol(cubic meter): "))
           fluid_density = float(input("fluid_density [kg/m^3]>>"))
           self.buoyancy_force(fluid_density,volume,9.81)
   ...
   def buoyancy_force(self, f,v,g):
       buoyancy=f*g*v
       print("bouyancy: ",buoyancy)
